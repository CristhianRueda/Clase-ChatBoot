...
#export OPENAI_API_KEY="sk-proj-YUuZMSSCk8oqy2mugbgWT3BlbkFJpkfON5PDJ0Di8tHXtjfo"
...
def get_response_openai(prompt):
    ...
    message_input = {
        'messages': [
            {'role': 'system', 'content': 'Eres un asistente virtual que responde conterminos argentinos'},
